...
def _first_kernel(A, B, C, M, N, K,
    ...
    rk = pid_k * CHUNK_SIZE + tl.arange(0, BLOCK_K)
    # pointers
    ...
    for k in tl.range(0, tl.cdiv(CHUNK_SIZE, BLOCK_K)):
        k_remaining = CHUNK_SIZE*(SPLIT_K+1) - k * (BLOCK_K)
